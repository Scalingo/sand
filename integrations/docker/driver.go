...
func NewDockerPlugin(nr sandnetwork.Repository, er endpoint.Repository, r Repository) *DockerPlugin {
	return &DockerPlugin{
...
func (p *DockerPlugin) GetCapabilities(ctx context.Context) (*network.CapabilitiesResponse, error) {
...
func (p *DockerPlugin) CreateNetwork(ctx context.Context, req *network.CreateNetworkRequest) error {
...
func (p *DockerPlugin) AllocateNetwork(ctx context.Context, req *network.AllocateNetworkRequest) (*network.AllocateNetworkResponse, error) {
	return nil, errors.New("unsupported")
}

func (p *DockerPlugin) DeleteNetwork(ctx context.Context, req *network.DeleteNetworkRequest) error {
...
func (p *DockerPlugin) FreeNetwork(ctx context.Context, req *network.FreeNetworkRequest) error {
	return nil
}

func (p *DockerPlugin) CreateEndpoint(ctx context.Context, req *network.CreateEndpointRequest) (*network.CreateEndpointResponse, error) {
	dpn, err := p.dockerPluginRepository.GetNetworkByDockerID(ctx, req.NetworkID)
	if err != nil {
...
func (p *DockerPlugin) DeleteEndpoint(ctx context.Context, req *network.DeleteEndpointRequest) error {
...
func (p *DockerPlugin) EndpointInfo(ctx context.Context, req *network.InfoRequest) (*network.InfoResponse, error) {
	return nil, nil
}

func (p *DockerPlugin) Join(ctx context.Context, req *network.JoinRequest) (*network.JoinResponse, error) {
	dpe, err := p.dockerPluginRepository.GetEndpointByDockerID(ctx, req.EndpointID)
	if err != nil {
		return nil, errors.Wrapf(err, "fail to get docker id binding")
	}
...
func (p *DockerPlugin) Leave(ctx context.Context, req *network.LeaveRequest) error {
	dpe, err := p.dockerPluginRepository.GetEndpointByDockerID(ctx, req.EndpointID)
	if err != nil {
		return errors.Wrapf(err, "fail to get docker id binding")
	}
...
func (p *DockerPlugin) DiscoverNew(ctx context.Context, req *network.DiscoveryNotification) error {
	return nil
}

func (p *DockerPlugin) DiscoverDelete(ctx context.Context, req *network.DiscoveryNotification) error {
	return nil
}

func (p *DockerPlugin) ProgramExternalConnectivity(ctx context.Context, req *network.ProgramExternalConnectivityRequest) error {
	return nil
}

func (p *DockerPlugin) RevokeExternalConnectivity(ctx context.Context, req *network.RevokeExternalConnectivityRequest) error {
	return nil
}
